 <section class='max-w-screen-md mx-auto ~px-4/8 ~py-8/32 space-y-8 text-center'>
    ...
    <a href='app' class='px-4 py-3 rounded-lg bg-slate-900 font-semibold text-white'>Join Game</a>
    <button class='px-4 py-3 rounded-lg border border-slate-300 font-semibold text-slate-400'>Sign up</button>
    </div>
  </section>